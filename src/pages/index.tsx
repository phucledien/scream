                                            ...
                                            <div className="text-left sm:text-right space-y-4">
                                                ...
                                                <div className="grid grid-cols-2 gap-4">
                                                    <a
                                                        ...
                                                        target="_blank"
                                                        type="button"
                                                        className="text-center block bg-animated-rainbow font-medium rounded-3xl px-4 py-2 w-full animate-ping text-white hover:shadow-xl transition ease-in-out duration-150"
                                                        rel="noreferrer"
                                                    >
                                                        <span>Docs</span>
                                                    </a>
